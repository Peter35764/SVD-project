...
int main() {
    ...
    // using namespace SVD_Project; // Раскомментируйте, если хотите писать AOIR_SVD_4 без SVD_Project::

    using Real = double; // Для этого теста используем double
    ...
    A << 1, 2, 3, 4, 5, 6, 7, 8, 9,
         ...
         3, 9, 4.98942, 0.324235, 443534.0, 345.0, 56.543853, 450.435234, 43.34353221; // Добавил .0 к целым числам для ясности типа double
