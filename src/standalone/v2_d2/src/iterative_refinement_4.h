#ifndef ITERATIVE_REFINEMENT_4_H
#define ITERATIVE_REFINEMENT_4_H
...
#include "svd_types.h" // Предполагается, что здесь может быть определение вашего типа T
#include <boost/multiprecision/cpp_dec_float.hpp>

// ЭТО ВАЖНОЕ ДОБАВЛЕНИЕ для совместимости Eigen и Boost.Multiprecision
// Должно быть после Eigen и Boost.Multiprecision основных заголовков.
...
class AOIR_SVD_4 {
public:
    // Если T - это boost::multiprecision::number<Backend, ExpressionTemplates>,
    // то MatrixDyn и VectorDyn будут использовать этот тип.
...
// Включение .hpp файла остается здесь
#include "iterative_refinement_4.hpp"

#endif // ITERATIVE_REFINEMENT_4_H