// Файл: src/iterative_refinement_5.h
...
#include <Eigen/Core>
#include <Eigen/SVD>    // Для BDCSVD
#include <string>
#include <vector>
#include <limits>       // Для std::numeric_limits

// boost/multiprecision/cpp_dec_float.hpp уже должен быть включен через svd_types.h
...
#endif // ITERATIVE_REFINEMENT_5_H
