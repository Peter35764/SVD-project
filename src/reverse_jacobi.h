...
public:
    ...
    const typename Base::SingularValuesType &singularValues() const { return m_singularValues; }
...
private:
    ...
    Eigen::JacobiRotation<Scalar> composeLeftRotation(const Index &i, const Index &j) const;
    Eigen::JacobiRotation<Scalar> composeRightRotation(const Index &i, const Index &j) const;
};
