...
int main() {
  ...
  SVDT::compareMatrices("SVD_Project::v0_GivRef_SVD", 5, 5);
  SVDT::compareMatrices("SVD_Project::v0_RevJac_SVD", 5, 5);
  /*
    ...
    std::vector<SVDT::MetricSettings> metricsSettings = {
        ...
        SVDT::MetricSettings(SVDT::RECON_ERROR, 0.7, true, "AVG recon error",
                             true),
        SVDT::MetricSettings(SVDT::MAX_DEVIATION, 0.7, false, "AVG max
    deviation", true), SVDT::MetricSettings(SVDT::MAX_DEVIATION, 0.7, true, "AVG
    max deviation", true)};
