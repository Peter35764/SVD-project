...
//Конструктор может быть использован самостоятельно для вычисления левых и правых сингулярных векторов и собственных чисел матрицы.  
//Дабы, получить левые и правые сингулярные вектора и собственных числа используют следующие методы класса: matrixV(), matrixU(), 
//singularValues(), соответственно. Данные функции возвращают матрицы размер N N, M M, M N.
