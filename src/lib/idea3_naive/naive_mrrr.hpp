#ifndef NAIVE_MRRR_HPP
#define NAIVE_MRRR_HPP

#include <lapacke.h>

#include <cmath>

#include "naive_mrrr.h"  // necessary for correct display in ide, does not affect the assembly process and can be removed

namespace SVD_Project {

template<typename _MatrixType>
NaiveMRRR_SVD<_MatrixType>::NaiveMRRR_SVD(const _MatrixType &matrix, unsigned int computationOptions)
{
...
template<typename _MatrixType>
NaiveMRRR_SVD<_MatrixType>& NaiveMRRR_SVD<_MatrixType>::compute_tgk(const _MatrixType& matrix)
{
