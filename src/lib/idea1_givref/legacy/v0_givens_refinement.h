#ifndef V0_GIVENS_REFINEMENT_H
#define V0_GIVENS_REFINEMENT_H
...
class v0_GivRef_SVD : public Eigen::SVDBase<v0_GivRef_SVD<_MatrixType>> {
  typedef Eigen::SVDBase<v0_GivRef_SVD> Base;
  typedef typename _MatrixType::Scalar Scalar;
  typedef typename _MatrixType::Index Index;

 public:
  // This structure is required for tests
  explicit v0_GivRef_SVD(const _MatrixType& matrix,
                         unsigned int computationOptions = 0);
  v0_GivRef_SVD& compute(const _MatrixType& matrix,
                         unsigned int computationOptions = 0);
...
template <typename _MatrixType>
struct Eigen::internal::traits<SVD_Project::v0_GivRef_SVD<_MatrixType>>
    : Eigen::internal::traits<_MatrixType> {
  typedef _MatrixType MatrixType;
};

#include "v0_givens_refinement.hpp"

#endif  // V0_GIVENS_REFINEMENT_H
