#ifndef V1_GIVENS_REFINEMENT_H
#define V1_GIVENS_REFINEMENT_H
...
class v1_GivRef_SVD : public Eigen::SVDBase<v1_GivRef_SVD<_MatrixType>> {
  typedef Eigen::SVDBase<v1_GivRef_SVD> Base;
 ...
 public:
  v1_GivRef_SVD() = default;
  // This structure is required for tests
  explicit v1_GivRef_SVD(const _MatrixType &matrix,
  ...
  v1_GivRef_SVD &compute(const _MatrixType &matrix,
                      unsigned int computationOptions = 0);
  v1_GivRef_SVD &compute(const _MatrixType &matrix, std::ostream *os,
                      unsigned int computationOptions = 0);
...
template <typename _MatrixType>
struct Eigen::internal::traits<SVD_Project::v1_GivRef_SVD<_MatrixType>>
    : Eigen::internal::traits<_MatrixType> {
  typedef _MatrixType MatrixType;
};

#include "v1_givens_refinement.hpp"

#endif  // V1_GIVENS_REFINEMENT_H
