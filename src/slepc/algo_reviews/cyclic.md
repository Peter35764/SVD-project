...
#### Параметры:  
SVD svd - ??? Некоторая структура, содержащая алгоритмы для решения svd \
...
* Получить количество сходящихся сингулярных значений и запустить цикл по вычислению sigma ???
...
* Заполнение векторов сингулярными векторами
